...
| LLY | 51.55x (stage 2) | 42.06x (stage 3) | 10.8% | 2 낮음 |
...
| MS | 21.37x (stage 5) | 3.1x (stage 5) | 8.4% | 4 높음 |
...
- **ORCL** (validation_failed): FAIL: 목표가 밴드 current price $146.65 does not match valuation-tab current price $153.28 - run scripts/target_band_gauge.py
